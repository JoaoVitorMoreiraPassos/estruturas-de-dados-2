...
void main()
{
    ...
    inserirTermo(&termos, "test10");
    inserirTermo(&termos, "test20");
    inserirTermo(&termos, "test8");
    inserirTermo(&termos, "test50");
    ...
    inserirSubTermoInTermo(&termos, "test3", "test345");
    inserirSubTermoInTermo(&termos, "test3", "test3456");
    inserirSubTermoInTermo(&termos, "test3", "test3457");
    inserirSubTermoInTermo(&termos, "test3", "test3458");
